...
public class GenEntity {
    ...
    //生成文件保存路径与包名
    private static String fileDir = "E:/IdeaProjects/zengs-javaee/zen-generate/entity/src/main/java/";
    private static String packagePath = "com.zengs.entity";
    ...
    public static void main_bak(String[] args) {
        ...
        if(tableNames.length>0){
            new GenEntity().generate(tableNames);
        }else {
            new GenEntity().generate();
        }
